...
class AirSimDroneEnv(AirSimEnv):
    ...
    #这个写好的计算奖励是 无人机跟踪静止目标的奖励函数 不加（0.3，0.3） 还没有收敛
    @property
    ...
    def interpret_action(self, action):
        if action == 0:
            ...
            #盘旋不动
            quad_offset = (0, 0, 0) #设置为(0.3,0.3,0.3)的时候，无人机飞向静止目标(10,10)大约3000step可以收敛，飞向移动目标(10,10)vx=0.1,vy = 0.1 大约3000step 可以收敛
        return quad_offset
