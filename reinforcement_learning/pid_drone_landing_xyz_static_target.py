...
Kp = 0.1  # 0.1 最后速度太大（0.7，0.7，0.6）#1.2#1.2  # 100 这些参数怎么设置 （0.1，0.15，0.1）
Ki = 0.0001
Kd = 0.1
...
x_poswanted = 10 #降落的目标点是（10,10,0）
y_poswanted = 10
z_poswanted = 0
...
def PIDcontroller(x_pos, y_pos, z_pos):
    ...
    z_diff = z_poswanted - z_pos #z方向上的误差
...
if __name__ == '__main__':
    ...
    plt.savefig("image/pid_landing_xyz_static_target/01_00001_01_best.png")
