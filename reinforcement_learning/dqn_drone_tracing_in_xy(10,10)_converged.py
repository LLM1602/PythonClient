...
dir = "E:/PyCharmProject/llm_AirSim_github_modified/PythonClient/reinforcement_learning/model_store/dqn_drone/best_model_for_static_object_converged"
...
if os.path.exists(dir+".zip"):
    print("已有模型，正在加载模型")
    model = DQN.load("./model_store/dqn_drone/best_model_for_static_object_converged",env,device="cuda")
